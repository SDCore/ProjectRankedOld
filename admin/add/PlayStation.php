<?php 
    ...
    if(isset($_POST['addUser'])) {
        ...
        $IDAPI = file_get_contents("https://api.jumpmaster.xyz/user/ID?platform=PS4&id=".$uid, false, stream_context_create($streamOpts));
...
<form action="#" method="POST">
    <div class="adminForm">
        <span class="title">Add PlayStation User</span>
